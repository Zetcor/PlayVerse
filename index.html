	...
	<head>
		...
		<style>
			...
			* {
			...
			/* Promotions Section */
			.promotions-section {
				background-color: var(--light-gray); /* same as --navy */
				color: var(--navy);
			}
			...
			.promo-img-box {
				height: 400px; /* or 250px depending on preference */
				width: 100%;
				overflow: hidden;
						...
						<ul class="navbar-nav gap-3">
							...
							<li class="nav-item">
								<a class="nav-link" href="offers.html"
									><i class="fa-solid fa-briefcase"></i>WHAT WE OFFER</a
								>
							</li>
							<li class="nav-item">
								<a class="nav-link" href="about.html"
									><i class="fa-solid fa-users"></i>ABOUT US</a
								>
							</li>
							<li class="nav-item">
			...
			<section class="hero d-flex align-items-center text-center">
				<div class="container">
					<div class="hero-content px-3 py-4 mx-auto">
						...
						<a href="offers.html" class="cta-button"> Browse PlayVerse </a>
					</div>
				</div>
			</section>
